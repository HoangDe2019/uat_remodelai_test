...
'When Call the request to unsubscribe a feature with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/unsubscribe_1', token, data)
