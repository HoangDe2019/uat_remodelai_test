...
'When Call the request to subscribe a feature with blank token'
...
'When Call the request to subscribe a feature with invalid token'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/subscribe', 'Bearer', data)
