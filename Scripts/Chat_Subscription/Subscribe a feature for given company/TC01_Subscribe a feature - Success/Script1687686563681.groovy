...
responseBodyOfUsers.each { info ->
	if(info.lastName.equals('nguyenla')) {
		itemlist.add(info)
	}
	else {
		//TODO
...
'When Call the request to subscribe a feature'
...
WS.verifyElementPropertyValue(res, "choice", paramData.getValue('choice', numberRecordInRows) + " - " + randomStringNumber)
WS.verifyElementPropertyValue(res, "topic", paramData.getValue('topic', numberRecordInRows) + " - " + randomString)
