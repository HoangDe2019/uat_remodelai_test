...
'When Call the request to create a completions with blank parameters'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'("api/v1/chat/completions", token, data)
