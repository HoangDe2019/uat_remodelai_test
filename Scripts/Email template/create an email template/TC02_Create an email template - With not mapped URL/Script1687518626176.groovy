...
'When Call the request to create new email template with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'('/api/v1/email/templateinvalid/create', token, data)
