...
'When Call the request to create new email template with invalid userId'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('/api/v1/email/template/create', token, data)
...
'When Call the request to create new email template with invalid userId'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPostMethod'('/api/v1/email/template/create', token, '')
