...
'When Call the request to create a new subscription with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'('/api/vmot/subscribe', token, data)
