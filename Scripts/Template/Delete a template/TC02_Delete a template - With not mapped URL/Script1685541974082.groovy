...
def templateId = {'99999'}

'When Call the request to delete template with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiDeleteMethod'('api/vmot/template/delete/' + templateId, token, '')
