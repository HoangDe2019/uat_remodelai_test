...
'When Call the request to delete template with blank token'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiDeleteMethod'('api/v1/template/delete/' + templateId, '', '')

'Then verify response code should be 401'
WS.verifyResponseStatusCode(res1, 401)

'When Call the request to delete template with invalid token'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiDeleteMethod'('api/v1/template/delete/' + templateId, 'Bearer', '')
