...
'When Call the request to delete template with invalid tempalteId'
ResponseObject res = CustomKeywords.'resources.api.buildApiDeleteMethod'('api/v1/template/delete/' + randomString, token, '')
