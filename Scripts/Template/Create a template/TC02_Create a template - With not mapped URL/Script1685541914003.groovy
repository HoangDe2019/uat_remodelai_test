...
'When Call the request to create new template with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/templateinvalid/create', token, data)
