...
ResponseObject responseTemplate1 = CustomKeywords.'resources.api.buildApiGetMethod'("api/v1/template/${templateId}", '', '')
...
ResponseObject responseTemplate2 = CustomKeywords.'resources.api.buildApiGetMethod'("api/v1/template/${templateId}", 'Bearer', '')
