...
'When Call the request to get email templates by invalid companyID'
def companyId = itemlist[itemlist.size()-1].companyId
ResponseObject responseTemplates = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/email/template/list/company' + companyId +'test', tokenId, '')
