...
ResponseObject responseCompanyTemplate = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/template/company/' + companyId, tokenId, '')
...
assert responseBodyOfTemplateCompanyDetail.templateId != null
WS.verifyElementPropertyValue(responseCompanyTemplate, "companyId", itemlist[itemlist.size()-1].companyId)
assert responseBodyOfTemplateCompanyDetail.displayName != null
WS.verifyElementPropertyValue(responseCompanyTemplate, "userId", itemlist[itemlist.size()-1].userId)
WS.verifyElementPropertyValue(responseCompanyTemplate, "email", itemlist[itemlist.size()-1].email)
