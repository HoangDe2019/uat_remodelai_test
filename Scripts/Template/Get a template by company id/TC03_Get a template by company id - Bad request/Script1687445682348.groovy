...
'When Call the request to get templates by invalid companyID'
def companyId = itemlist[itemlist.size()-1].companyId
ResponseObject responseTemplates = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/template/company/' + companyId +'test', tokenId, '')
