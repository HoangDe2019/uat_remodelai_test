...
'When Call the request to get template by emailtemplateId with URL not mapped'
ResponseObject responseTemplate = CustomKeywords.'resources.api.buildApiGetMethod'("api/v1/email/templateinvalid/${templateId}", token, '')
