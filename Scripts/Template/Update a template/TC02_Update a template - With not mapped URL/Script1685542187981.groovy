...
// get new record which was created before
...
'When Call the request to update a template with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPutMethod'('api/vmot/template/update', token, data)
