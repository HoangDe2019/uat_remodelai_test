...
'When Call the request to get lead forms of a company with URL not mapped'
def companyId = responseBodyOfUsers[0].companyId
ResponseObject responseFormDetail = CustomKeywords.'resources.api.buildApiGetMethod'('api/vmot/leadForm/company/' + companyId, token, '')
