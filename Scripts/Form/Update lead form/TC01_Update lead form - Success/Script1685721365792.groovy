...
'When Call the request to update lead form'
ResponseObject res = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadForm/update', token, data)
...
WS.verifyElementPropertyValue(res, "leadFormId", itemlist[0].leadFormId)
WS.verifyElementPropertyValue(res, "templateId", itemlist[0].templateId)
WS.verifyElementPropertyValue(res, "leadFormName", paramData.getValue("leadFormName", numberRecordInRows) + randomString)
WS.verifyElementPropertyValue(res, "version", itemlist[0].version + 1)
