...
//data1 = '{\n  \"companyId\": \"'+ itemlist[0].companyId +'\",\n  \"leadFormId\": \"' + itemlist[0].leadFormId + '\",\n  \"leadFormName\": \"' + itemlist[0].leadFormName + '\",\n  \"templateId\": \"' + itemlist[0].templateId + '\"\n}'
//
//KeywordUtil.logInfo('Data request in body: ' + data1)
//
//'When Call the request to update lead form duplicated with information existing'
//ResponseObject res1 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadForm/update', token, data1)
//
...
'When Call the request to update lead form with invalid request body data'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadForm/update', token, data2)
...
'When Call the request to update lead form with invalid leadFormId'
ResponseObject res3 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadForm/update', token, data3)
