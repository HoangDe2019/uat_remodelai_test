...
responseBody.each { info ->
	...
	assert info.leadFormName != null || info.leadFormName == null
	assert info.companyId != null
	assert info.templateId != null || info.templateId == null
	assert info.leadFormSettings != null || info.leadFormSettings == null
	assert info.isActive == true || info.isActive == false
