...
'When Call the request to delete a lead form with invalid URL'
def responseLeadForm = CustomKeywords.'resources.api.buildApiDeleteMethod'("api/vmot/leadForm/delete/" + leadFormId, token, '')

'Then verify response code should be 404'
WS.verifyResponseStatusCode(responseLeadForm, 404)

'And Verify response body is properly'
WS.verifyElementPropertyValue(responseLeadForm, "error", 'Not Found')
