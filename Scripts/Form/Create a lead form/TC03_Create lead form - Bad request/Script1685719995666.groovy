...
'When Call the request to create new lead form with invalid companyId'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/leadForm/create', token, data1)

'Then verify response code should be 400'
WS.verifyResponseStatusCode(res1, 400)

def data2 = "{'000000000000000000000000'}"
'When Call the request to create new lead form with invalid request body'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/leadForm/create', token, data2)
