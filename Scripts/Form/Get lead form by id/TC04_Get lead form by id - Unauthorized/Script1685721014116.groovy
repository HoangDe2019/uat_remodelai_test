...
ResponseObject responseFormDetail1 = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/leadForm/' + formId, '', '')
...
ResponseObject responseFormDetail2 = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/leadForm/' + formId, 'Bearer', '')
