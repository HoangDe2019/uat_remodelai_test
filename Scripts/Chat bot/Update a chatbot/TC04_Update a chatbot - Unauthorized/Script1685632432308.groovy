...
def ObjChatbots = responseBodyOfChatbots[0]
...
'When Call the request to update a chatbot with blank token'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/chatbot/update', '', data)

'Then verify response code should be 401'
WS.verifyResponseStatusCode(res1, 401)

'When Call the request to update a chatbot with invalid token'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/chatbot/update', '', data)
