...
def responseChatbot = CustomKeywords.'resources.api.buildApiGetMethod'("api/v1/chatbot/000000000000000000000", token, '')

'Then verify response code should be 400'
WS.verifyResponseStatusCode(responseChatbot, 400)
