...
'When Call the request to get chatbot by chatbotId with URL not mapped'
def responseChatbot2 = CustomKeywords.'resources.api.buildApiGetMethod'("api/vmot/chatbot/${chatbotObj}", token, '')
