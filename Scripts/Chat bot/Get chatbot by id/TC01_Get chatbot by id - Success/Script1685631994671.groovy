...
def responseChatbot2 = CustomKeywords.'resources.api.buildApiGetMethod'("api/v1/chatbot/${chatbotObj}", token, '')
...
WS.verifyElementPropertyValue(responseChatbot2, "companyId", itemlist[0].companyId)
WS.verifyElementPropertyValue(responseChatbot2, "chatBotName", responseBodyOfChatbots1[0].chatBotName)
WS.verifyElementPropertyValue(responseChatbot2, "agentName", responseBodyOfChatbots1[0].agentName)
WS.verifyElementPropertyValue(responseChatbot2, "agentTitle", responseBodyOfChatbots1[0].agentTitle)
WS.verifyElementPropertyValue(responseChatbot2, "leadFormId", responseBodyOfChatbots1[0].leadFormId)
WS.verifyElementPropertyValue(responseChatbot2, "chatBotSettings", responseBodyOfChatbots1[0].chatBotSettings)
WS.verifyElementPropertyValue(responseChatbot2, "chatBotColor", responseBodyOfChatbots1[0].chatBotColor)
WS.verifyElementPropertyValue(responseChatbot2, "buttonColor", responseBodyOfChatbots1[0].buttonColor)
WS.verifyElementPropertyValue(responseChatbot2, "avatar", responseBodyOfChatbots1[0].avatar)
