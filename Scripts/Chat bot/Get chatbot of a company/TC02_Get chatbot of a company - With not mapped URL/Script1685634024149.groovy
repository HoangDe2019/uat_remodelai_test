...
'When Call the request to get chatbot of a company with URL not mapped'
def responseChatbots = CustomKeywords.'resources.api.buildApiGetMethod'("api/vmot/chatbot/company/${itemlist[0].companyId}", token, '')
