...
'When Call the request to active chatbot by chatbotId and company'
def responseChatbot2 = CustomKeywords.'resources.api.buildApiPostMethod'("api/v1/chatbot/${itemlist[itemlist.size()-1].companyId}/activate/${chatbotObj}", token, '')

'Then verify response code should be 201'
WS.verifyResponseStatusCode(responseChatbot2, 201)

WS.verifyMatch(responseChatbot2.getResponseBodyContent(), "Chatbot activated successfully.", true)
