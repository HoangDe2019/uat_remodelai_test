...
'When Call the request to get chatbot activate of a company'
def responseChatbots = CustomKeywords.'resources.api.buildApiGetMethod'("api/v1/chatbot/company/activate/${itemlist[0].companyId + 123}", token, '')
