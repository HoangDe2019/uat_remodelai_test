...
'When Call the request to delete chatbot by chatbotId with URL not mapped'
def responseChatbot2 = CustomKeywords.'resources.api.buildApiDeleteMethod'("api/vmot/chatbot/delete/${chatbotObj}", token, '')
