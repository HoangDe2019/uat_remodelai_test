...
'When Call the request to delete chatbot by chatbotId with blank token'
def responseChatbot2 = CustomKeywords.'resources.api.buildApiDeleteMethod'("api/v1/chatbot/delete/${chatbotObj}", '', '')

'Then verify response code should be 401'
WS.verifyResponseStatusCode(responseChatbot2, 401)

'When Call the request to delete chatbot by chatbotId with invalid token'
def responseChatbot3 = CustomKeywords.'resources.api.buildApiDeleteMethod'("api/v1/chatbot/delete/${chatbotObj}", 'Bearer', '')
