...
'When Call the request to delete chatbot by invalid chatbotId'
def responseChatbot1 = CustomKeywords.'resources.api.buildApiDeleteMethod'("api/v1/chatbot/delete/0000000000000", token, '')
