...
'When Call the request to delete chatbot by chatbotId'
def responseChatbot2 = CustomKeywords.'resources.api.buildApiDeleteMethod'("api/v1/chatbot/delete/${chatbotObj}", token, '')
