...
'When Call the request to create a chatbot'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/chatbot/create', token, data)
...
assert result.chatBotId != null
WS.verifyElementPropertyValue(res, "companyId", itemlist[itemlist.size()-1].companyId)
WS.verifyElementPropertyValue(res, "chatBotName", paramData.getValue('chatBotName', numberRecordInRows) + randomString)
WS.verifyElementPropertyValue(res, "agentName", paramData.getValue('agentName', numberRecordInRows) + randomString)
WS.verifyElementPropertyValue(res, "agentTitle", null)
WS.verifyElementPropertyValue(res, "leadFormId", null)
WS.verifyElementPropertyValue(res, "chatBotColor", colorValue)
WS.verifyElementPropertyValue(res, "buttonColor", colorValue)
WS.verifyElementPropertyValue(res, "avatar", null)
