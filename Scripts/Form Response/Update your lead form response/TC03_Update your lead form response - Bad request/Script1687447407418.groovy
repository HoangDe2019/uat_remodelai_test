...
'When Call the request to update lead form response with invalid leadFormResponseId'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadFormResponse/update', token, data)

'Then verify response code should be 400'
WS.verifyResponseStatusCode(res1, 400)

'When Call the request to update lead form response with blank request body'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadFormResponse/update', token, '')
