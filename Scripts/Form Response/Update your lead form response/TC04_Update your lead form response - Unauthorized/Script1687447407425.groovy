...
'When Call the request to update a lead form response with blank token'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadFormResponse/update', '', data)

'Then verify response code should be 401'
WS.verifyResponseStatusCode(res1, 401)

'When Call the request to update a lead form response with invalid token'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/leadFormResponse/update', 'Bearer', data)
