...
'When Call the request to get detail of lead form response by LedFormID'
def leadFormResponseId = responseBodyOfForms[0].leadFormResponseId
ResponseObject responseFormDetail = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/leadFormResponse/' + leadFormResponseId, token, '')
...
WS.verifyElementPropertyValue(responseFormDetail, "companyId", companyId)
WS.verifyElementPropertyValue(responseFormDetail, "leadFormId", responseBodyOfForms[0].leadFormId)
WS.verifyElementPropertyValue(responseFormDetail, "chatBotId", responseBodyOfForms[0].chatBotId)
WS.verifyElementPropertyValue(responseFormDetail, "leadFormResponseId", leadFormResponseId)
WS.verifyElementPropertyValue(responseFormDetail, "formAnswerList.questionText", responseBodyOfForms[0].formAnswerList.questionText)
WS.verifyElementPropertyValue(responseFormDetail, "formAnswerList.answers", responseBodyOfForms[0].formAnswerList.answers)