...
ResponseObject responseFormResponse1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/leadFormResponse/save', token, data1)
...
ResponseObject responseFormResponse2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/leadFormResponse/save', token, data2)
