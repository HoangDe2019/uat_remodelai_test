...
ResponseObject responseFormResponse1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/leadFormResponse/save', '', data)
...
ResponseObject responseFormResponse2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/leadFormResponse/save', 'Bearer', data)
