...
'When Call the request to get list of models with URL not mapped'
ResponseObject response = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/modelinvalid/all', tokenId, '')
