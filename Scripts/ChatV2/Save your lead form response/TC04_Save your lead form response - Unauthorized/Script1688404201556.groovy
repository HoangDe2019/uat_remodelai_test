...
String randomString = RandomStringUtils.random(15, charset.toCharArray())
...
String auToken = randomString

'When Call the request to save a lead form response with blank token'
ResponseObject responseFormResponse1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v2/leadFormResponse/save?token=', '', data)

'Then verify response code should be 401'
WS.verifyResponseStatusCode(responseFormResponse1, 401)

'When Call the request to save a lead form response with invalid token'
ResponseObject responseFormResponse2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v2/leadFormResponse/save?token=' + auToken, 'Bearer', data)

'Then verify response code should be 401'
WS.verifyResponseStatusCode(responseFormResponse2, 401)