...
String auToken =  CustomKeywords.'resources.api.getAuthToken'()

'When Call the request to save a lead form response with invalid leadFormId'
ResponseObject responseFormResponse1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v2/leadFormResponse/save?token=' + auToken, token, data)

'Then verify response code should be 400'
WS.verifyResponseStatusCode(responseFormResponse1, 400)

def data2 = "{'0000000000000000000'}"

'When Call the request to save a lead form response with invalid request body data'
ResponseObject responseFormResponse2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v2/leadFormResponse/save?token=' + auToken, token, data2)

'Then verify response code should be 400'
WS.verifyResponseStatusCode(responseFormResponse2, 400)
