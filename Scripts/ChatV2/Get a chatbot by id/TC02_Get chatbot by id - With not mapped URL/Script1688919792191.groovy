...
ResponseObject responseChatBotCmpany = CustomKeywords.'resources.api.buildApiGetMethod'('api/v2/chatbot/company/' + companyId + '?' + paramRequestURI, token, '')
...
def responseChatbot2 = CustomKeywords.'resources.api.buildApiGetMethod'("api/vhai/chatbot/${chatbotObj}?${paramRequestURI}", token, '')
