...
def chatbotObj = responseBodyOfChatBotCompanyDetail[responseBodyOfChatBotCompanyDetail.size()-1].chatBotId + 'invalid'

'When Call the request to get chatbot by invalid chatbotId'
