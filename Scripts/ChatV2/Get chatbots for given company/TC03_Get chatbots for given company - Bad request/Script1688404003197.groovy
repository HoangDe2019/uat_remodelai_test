...
ResponseObject responseChatBotCmpany = CustomKeywords.'resources.api.buildApiGetMethod'('api/v2/chatbot/company/' + companyId + 'test?' + paramRequestURI, tokenId, '')

'Then verify response code should be 400'
WS.verifyResponseStatusCode(responseChatBotCmpany, 400)
