...
'When Call the request to create a completions with invalid request body'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'("api/v2/chat/completions?${paramRequestURI}", token, '')
