...
def paramURI = ["companyId": itemlist[itemlist.size()-1].companyId, "token": CustomKeywords.'resources.api.getAuthToken'()]
...
'When Call the request to Create new completion'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethod'("api/v2/chat/completions?${paramRequestURI}", token, data)
...
WS.verifyElementPropertyValue(res, "model", "gpt-3.5-turbo-0613")
WS.verifyElementPropertyValue(res, "object", "chat.completion")
