...
'When Call the request to get a wordpress script with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiGetMethod'('api/'+ randomString + '/wordpress', token, '')
