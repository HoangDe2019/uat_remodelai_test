...
'When Call the request to get a wordpress script'
ResponseObject res = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/wordpress', token, '')
...
WS.verifyElementPropertyValue(res, "companyId", CustomKeywords.'resources.api.getCompanyInfoAccout'())
WS.verifyElementPropertyValue(res, "token", CustomKeywords.'resources.api.getAuthToken'())
