...
'When Call the request to create a new reactjs script with invalid companyId'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/reactjs', token, '')

'Then verify response code should be 400'
WS.verifyResponseStatusCode(res1, 400)

def data2 = "{'${randomString}'}"
'When Call the request to create a new reactjs script with invalid request body data'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/reactjs', token, data2)
