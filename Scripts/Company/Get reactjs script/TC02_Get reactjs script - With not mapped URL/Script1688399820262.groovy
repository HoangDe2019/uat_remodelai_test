...
'When Call the request to get reactjs script with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiGetMethod'('api/vmot/reactjs', token, '')
