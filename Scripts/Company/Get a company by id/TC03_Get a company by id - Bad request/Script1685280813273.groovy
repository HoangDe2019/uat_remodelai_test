...
'When Call the request to get company by invalid companyID'
def companyId = responseBodyOfComapanies.keySet()
ResponseObject responseCompany = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/company/' + companyId[0] +'test', tokenId, '')

'Then verify response code should be 400'
WS.verifyResponseStatusCode(responseCompany, 400)
