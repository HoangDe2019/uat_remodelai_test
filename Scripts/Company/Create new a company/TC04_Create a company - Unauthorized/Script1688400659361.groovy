...
'When Call the request to create a new company with unauthorized'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/company/signup', '', data)

'Then verify response code should be 401'
WS.verifyResponseStatusCode(res1, 401)

'When Call the request to create a new company with unauthorized'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/company/signup', randomString, data)
