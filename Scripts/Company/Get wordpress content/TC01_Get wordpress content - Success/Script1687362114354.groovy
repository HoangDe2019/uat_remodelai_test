...
'When Call the request to get wordpress content'
ResponseObject res = CustomKeywords.'resources.api.buildApiGetMethod'('api/v1/wordpress/content', token, '')
...
assert !result.empty : 'No data body!'

'And Verify response body is properly'
assert result.contains('https://drive.google.com/file/d/1TjITATDsBceeQZgBpndZ-_nu_hgDLRw3/view?usp=sharing')
