...
'When Call the request to update info for a company with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/companyinvaild/update', tokenId, data)

'Then verify response code should be 404'
WS.verifyResponseStatusCode(res, 404)


def responseBodyOfCompany = jsonSlurper.parseText(res.getResponseBodyContent())
