...
'When Call the request to update info company with bad request'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/company/update', tokenId, null)
...
'When Call the request to update info company with bad request'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/company/update', tokenId, data)
