...
'When Call the request to update infor for a company'
ResponseObject res = CustomKeywords.'resources.api.buildApiPutMethod'('api/v1/company/update', tokenId, data)

'Then verify response code should be 200 updated'
