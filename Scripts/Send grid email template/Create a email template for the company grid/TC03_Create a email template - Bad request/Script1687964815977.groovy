...
'When Call the request to create new a email template with invalid param request'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/sendgrid/email/template/create', token, data)
...
'When Call the request to create new a email template with invalid request body'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/sendgrid/email/template/create', token, data2)
