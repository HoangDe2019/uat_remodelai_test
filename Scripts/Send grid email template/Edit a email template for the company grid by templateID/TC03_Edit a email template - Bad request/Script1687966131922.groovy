...
'When Call the request to edit a email template with invalid param request'
ResponseObject res1 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/sendgrid/email/template/' + randomString + '/edit', token, data)
...
'When Call the request to edit a email template with invalid param request'
ResponseObject res2 = CustomKeywords.'resources.api.buildApiPostMethod'('api/v1/sendgrid/email/template/' + randomString + '/edit', token, data2)
