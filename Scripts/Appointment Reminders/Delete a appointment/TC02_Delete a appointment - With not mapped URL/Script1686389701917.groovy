...
'When Call the request to delete appointment with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiPostMethodByFormData'('deleteinvalid', '', quersyData)
