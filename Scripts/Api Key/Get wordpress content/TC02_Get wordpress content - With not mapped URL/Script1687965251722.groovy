...
'When Call the request to get wordpress script with URL not mapped'
ResponseObject res = CustomKeywords.'resources.api.buildApiGetMethod'('api/vmot/wordpress/content', token, data)
